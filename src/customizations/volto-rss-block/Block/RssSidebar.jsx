// CUSTOMIZATION:
// - added hide_date checkbox to hide the date in the card 
// - added show_description checkbox to show the description in the card
// - added cards_per_row select to choose 3 or 4 cards per row
