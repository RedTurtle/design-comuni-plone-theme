 ...
 *
 * Customization: Added aria-expanded and aria-controls to the toolbar shrink button for accessibility.
 * this file can be removed when the customization is included in Volto core
