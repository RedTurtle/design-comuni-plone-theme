 ...
 *   `<link rel="manifest" ...>` tags (favicon.ico, icon.svg, apple-touch-icon.png,
 *   site.webmanifest) since favicon/manifest markup is generated by volto-site-settings instead.
 * - Added `<meta property="og:type" content="website" />`.
 * - Added `shrink-to-fit=no` to the `viewport` meta content (upstream only sets
