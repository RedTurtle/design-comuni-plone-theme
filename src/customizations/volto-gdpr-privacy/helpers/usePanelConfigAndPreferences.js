...
const usePanelConfigAndPreferences = (cookies, forceLoad) => {
  ...
  console.log(hasOldStyleConfig, 'hasoldstyle');
  console.log(oldStylePanelConfig, 'oldstyle');
  ...
  console.log(panelConfigStatus, 'panelconfigstatus');
  console.log(defaultPreferences, 'defaultpref');
